...
// ReconcilerConfig containers configuration for the periodic reconciler.
type ReconcilerConfig struct {
	...
	// detects that a value is no longer in the datastore but still exits in the cache.
	DisableMissingInDatastore bool

	// DisableMissingInKubernetes disables queueing of updates when reconciler detects
